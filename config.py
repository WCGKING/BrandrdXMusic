...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Bugsirtg/BUG/edit/main/config.py",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BUGMUSICCHAT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/BUGMUSICCHAT")
